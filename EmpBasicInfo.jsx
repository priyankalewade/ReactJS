					...
					<form className="col-lg-12 formcontainer">
				    	...
				    	<div className="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
				    		...
				    		<div className="input-group">
					    		...
					    		<input type="Password" value={this.state.password} ref="password" className="form-control"  onChange={this.handleChange.bind(this)} />
					    	</div>
				    	</div>
				    	<div className="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
				    		...
				    		<div className="input-group">
					    		<span className="input-group-addon"><i className="fa fa-lock"></i></span>
					    		<input type="Password" value={this.state.cpassword} ref="cpassword" className="form-control"  onChange={this.handleChange.bind(this)} />
					    	</div>
				    	</div>
			    	</div>	
